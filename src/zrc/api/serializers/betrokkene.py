...
class RolNatuurlijkPersoonSerializer(serializers.ModelSerializer):
    ...
    sub_verblijf_buitenland = SubVerblijfBuitenlandSerializer(required=False, allow_null=True)
    ...
    def create(self, validated_data):
        ...
        sub_verblijf_buitenland_data = validated_data.pop('sub_verblijf_buitenland', None)
