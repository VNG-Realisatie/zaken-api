    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                choices=[
                    (
                        "opdrachtgever",
                        "De gerelateerde zaak levert een bijdrage aan het bereiken van de uitkomst van de onderhanden zaak.",
                    ),
                    (
                        "opdrachtnemer",
                        "Aan het bereiken van de uitkomst van de gerelateerde zaak levert de onderhanden zaak een bijdrage.",
                    ),
                ],
                help_text="De datum waarop verzocht is om de behandeling van de gerelateerde ZAAK uit te gaan voeren.",
                max_length=14,
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                ...
                null=True,
                verbose_name="datum status gezet",
            ),
        ),
        migrations.AddField(
            model_name="zaak",
            ...
            field=models.DateField(
                blank=True,
                help_text="De datum waarop de uitvoering van de gerelateerde ZAAK afgerond is.",
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                max_length=80,
                verbose_name="resultaatomschrijving",
            ),
        ),
        migrations.AddField(
            model_name="zaak",
            ...
            field=models.DateField(
                blank=True,
                help_text="De datum waarop met de uitvoering van de gerelateerde ZAAK is gestart.",
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                max_length=80,
                verbose_name="status-omschrijving generiek",
            ),
        ),
        migrations.AddField(
            model_name="zaak",
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                help_text="De unieke identificatie van de gerelateerde ZAAK.",
                max_length=40,
                verbose_name="zaakidentificatie",
            ),
        ),
        migrations.AddField(
            model_name="zaak",
            ...
            field=models.CharField(
                blank=True,
                help_text="Algemeen gehanteerde omschrijving van de aard van ZAAKen van het ZAAKTYPE waartoe de gerelateerde zaak behoort.",
                max_length=80,
                verbose_name="zaaktype-omschrijving generiek",
            ),
        ),
        migrations.AddField(
            model_name="zaak",
            ...
            field=models.CharField(
                blank=True,
                help_text="De algemeen gehanteerde code van de aard van ZAAKen van het ZAAKTYPE waartoe de gerelateerde zaak behoort.",
                max_length=10,
                verbose_name="zaaktypecode",
            ),
        ),
        migrations.AddField(
            model_name="zaak",
