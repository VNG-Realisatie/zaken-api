    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Het gegeven is afleidbaar uit de historie van de attribuutsoort Datum status gezet van van alle statussen bij de desbetreffende zaak.",
                verbose_name="indicatie laatst gezette status",
            ),
        ),
        migrations.AddField(
