...
class NatuurlijkPersoonAdmin(admin.ModelAdmin):
    list_display = ['rol', 'zaakobject', 'zakelijk_rechtHeeft_als_gerechtigde',
                    'inp_bsn', 'anp_identificatie', 'inp_a_nummer']


@admin.register(NietNatuurlijkPersoon)
class NietNatuurlijkPersoonAdmin(admin.ModelAdmin):
    list_display = ['rol', 'zaakobject', 'zakelijk_rechtHeeft_als_gerechtigde', 'inn_nnp_id', 'ann_identificatie']
